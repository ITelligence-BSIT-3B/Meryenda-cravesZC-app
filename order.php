        ...
        <div class="container">
            ...
            <form action="" method="POST" class="order">
                ...
                <fieldset>
                    ...
                    <textarea name="address" rows="10" placeholder="Input Address" class="input-responsive" required></textarea>
										
					<div class="order-label">Payment Method</div>
                    <textarea type="text" placeholder="COD / PICK UP" class="input-responsive" required></textarea>
            ...
            <?php 
                ...
                if(isset($_POST['submit']))
                {
					...
					$customer_payment = $_POST['payment'];
